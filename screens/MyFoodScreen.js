...
var C5 = '#E7E5DF'; //text
//list of food that the user have recieved
export default class MyFoodScreen extends Component{
  constructor(){
    super()
    this.state = {
  ...
  getRecievedFoodList =()=>{
    this.requestRef = db.collection("requested_Food").where('userId','==',this.state.userId).where("status", '==','received').onSnapshot((snapshot)=>{
